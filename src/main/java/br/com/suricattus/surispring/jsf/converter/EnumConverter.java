 ...
 *
 */
@FacesConverter("br.com.suricattus.surispring.jsf.converter.EnumConverter")
public class EnumConverter implements Converter{
	
	private static final String ATTRIBUTE_ENUM_TYPE = "br.com.suricattus.surispring.jsf.converter.EnumConverter.enumType";
