...
@FacesConverter("br.com.suricattus.surispring.jsf.converter.SimpleObjectConverter")
public class SimpleObjectConverter implements Converter{
	
	private static final String OBJECT_VALUES_ATTR = "br.com.suricattus.surispring.jsf.converter.SimpleObjectConverter.OBJECT_VALUES_ATTR";
